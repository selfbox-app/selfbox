  ...
  return (
    <div>
      ...
      <ConfirmDeleteDialog
        ...
        description="Are you sure you want to delete your account? This action is permanent and cannot be undone. All your data will be removed."
        onConfirm={() => deleteAccount.mutate({ confirm: true })}
