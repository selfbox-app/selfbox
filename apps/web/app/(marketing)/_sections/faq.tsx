...
const faqItems = [
  {
    question: "What is Selfbox?",
    answer:
      "Selfbox is an open-source, self-hostable file storage platform. Think of it as your own Dropbox or Google Drive that you control completely\u2014deploy it on your own servers, use your own storage backend, and own your data.",
  },
  {
    question: "What storage providers are supported?",
    answer:
      "Selfbox supports local filesystem, AWS S3, Cloudflare R2, and Vercel Blob out of the box. You can switch between them by changing a single environment variable. No code changes required.",
  },
  {
    question: "Is Selfbox free to use?",
    answer:
      "Yes. Selfbox is free and open source. You can use it for personal projects, your team, or your entire organization at no cost. You only pay for the infrastructure you choose to host it on.",
  },
  {
  ...
  {
    question: "How do I deploy Selfbox?",
    answer:
      ...
      <div className="grid-layout w-full py-20">
        ...
        >
          ...
          <p className="mkt-body max-w-lg text-balance text-white/50">
            Deploy Selfbox in minutes and take back control of your file storage.
