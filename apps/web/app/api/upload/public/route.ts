...
import { files, uploadLinks, workspaces } from "@selfbox/database";
import {
...
import { sha256Buffer } from "@/server/desktop/checksum";
import {
...
export async function POST(req: NextRequest) {
  ...
  // Emit sync event so desktop clients pick up this file.
  if (inserted) {
