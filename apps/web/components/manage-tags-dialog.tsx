              ...
              editingId === tag.id ? (
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent side="top" sideOffset={8}>Save</TooltipContent>
                    </Tooltip>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Button
                      ...
                      <TooltipContent side="top" sideOffset={8}>Cancel</TooltipContent>
                    </Tooltip>
                  </div>
                ...
                >
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent side="top" sideOffset={8}>Edit</TooltipContent>
                  </Tooltip>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button
