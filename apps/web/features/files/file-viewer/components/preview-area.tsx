...
const PdfPreview = dynamic(() => import("./pdf-preview").then((m) => m.PdfPreview), { ssr: false });
const DocxPreview = dynamic(() => import("./docx-preview").then((m) => m.DocxPreview), { ssr: false });
...
export function PreviewArea({
  ...
  switch (viewerType) {
    ...
    case "docx":
      return previewUrl ? <DocxPreview url={previewUrl} /> : null;
    case "csv":
