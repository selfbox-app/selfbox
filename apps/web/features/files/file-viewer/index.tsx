...
export function FileViewer({ fileId }: { fileId: string }) {
  ...
  if (!file) {
    return (
      <div>
        <header className="sticky top-0 z-40 flex h-14 shrink-0 items-center gap-2 border-b border-border bg-background/80 backdrop-blur-lg px-4">
          <Button
            variant="ghost"
            size="sm"
            ...
            <div className="rounded-lg border bg-card p-5">
              ...
              <dl className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <dd className="text-xs">{formatDateTime(file.updatedAt)}</dd>
                </div>
                <div className="flex justify-between">
