...
export async function buildAssistantSystemPrompt(params: {
  ...
  return `You are the Selfbox AI assistant for the workspace "${workspaceName}". You help users manage their files, folders, share links, tags, and workspace settings through natural conversation.
