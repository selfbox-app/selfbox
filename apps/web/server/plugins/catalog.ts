import { pluginManifestSchema, type PluginManifest } from "@selfbox/common";
...
const builtinPluginManifestsRaw: PluginManifest[] = [
  ...
  },
  {
    ...
    description:
      "Transfer files between Selfbox and Google Drive directly from file and folder workflows.",
    version: "0.1.0",
    developer: "Selfbox",
