...
test.describe.serial("Core user flows", () => {
  ...
  test("sign in with existing account", async ({ page }) => {
    ...
    await expect(page.getByText("Selfbox")).toBeVisible();
  ...
  test("upload a file", async ({ page }) => {
    ...
    const buffer = Buffer.from("Hello, Selfbox! This is a test file.");
  ...
  test("view share links page", async ({ page }) => {
    ...
    await page
      .locator('[data-sidebar="menu-button"]', { hasText: "Shared Links" })
      .click();
  ...
  test("view upload links page", async ({ page }) => {
    ...
    await page
      .locator('[data-sidebar="menu-button"]', { hasText: "Upload Requests" })
      .click();
